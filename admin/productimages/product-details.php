...
?>
					...
					<div class="products">
						...
						<a href="product-details.php?page=product&action=add&id=<?php echo $rws['id']; ?>" class="lnk btn btn-primary" style="height:34px;padding-top: 5px;">Добавить в корзину</a>
...
<div class="stock-container info-container m-t-10">
								<div class="row">
									<div class="col-sm-3">
										<div class="stock-box">
											<span class="label">Марка/Лейбл :</span>
										</div>	
									</div>
									<div class="col-sm-9">
										<div class="stock-box">
...
?>
											...
											<div class="reviews" style="border: solid 1px #000; padding-left: 2% ">
												<div class="review">
													...
													<div class="text"><b>Качество :</b>  <?php echo htmlentities($rvw['quality']);?> звезд(а)</div>
													<div class="text"><b>Цена :</b>  <?php echo htmlentities($rvw['price']);?> звезд(а)</div>
													<div class="text"><b>Обслуживание :</b>  <?php echo htmlentities($rvw['value']);?> звезд(а)</div>
