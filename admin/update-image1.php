...
$_SESSION['msg']="Изображение обновлено успешно!";
...
<head>
	...
	<title>Admin| Обновить 1-е изображение</title>
					...
					<div class="content">
						...
						<div class="module">
							<div class="module-head">
								<h3>Обновить 1-е изображение</h3>
							</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">1-е изображение</label>
<div class="controls">
...
<div class="control-group">
<label class="control-label" for="basicinput">Новое изображение</label>
<div class="controls">
