...
<head>
	...
	<title>Admin| Подкатегория</title>
...
<div class="controls">
<input type="text" placeholder="Вставьте название подкатегории"  name="subcategory" class="span8 tip" required>
</div>
</div>
...
?>									
										<tr>
											...
											<a href="subcategory.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Вы уверены, что хотите удалить запись?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
