...
{?>
									...
									<strong>Все в порядке!</strong>	<?php echo htmlentities($_SESSION['msg']);?><?php echo htmlentities($_SESSION['msg']="");?>
									</div>
<?php } ?>
...
<div class="control-group">
<label class="control-label" for="basicinput">Марка/лейбл продукта</label>
<div class="controls">
<input type="text"    name="productCompany"  placeholder="Вставить марку/лейбл продукта" value="<?php echo htmlentities($row['productCompany']);?>" class="span8 tip" required>
</div>
</div>
<div class="control-group">
<label class="control-label" for="basicinput">Продукт без скидки</label>
<div class="controls">
<input type="text"    name="productpricebd"  placeholder="Ingrese Цена del producto" value="<?php echo htmlentities($row['productPriceBeforeDiscount']);?>"  class="span8 tip" required>
</div>
</div>

<div class="control-group">
<label class="control-label" for="basicinput">Цена продажи продукта</label>
<div class="controls">
<input type="text"    name="productprice"  placeholder="Введите отпускную цену товара" value="<?php echo htmlentities($row['productPrice']);?>" class="span8 tip" required>
</div>
</div>
...
<div class="controls">
<textarea  name="productDescription"  placeholder="Введите описание продукта" rows="6" class="span9 tip">
...
<div class="control-group">
<label class="control-label" for="basicinput">1-е изображение продукта</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage1']);?>" width="200" height="100"> <a href="update-image1.php?id=<?php echo $row['id'];?>">Change Image1</a>
</div>
</div>


<div class="control-group">
<label class="control-label" for="basicinput">2-ое изображение продукта</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage2']);?>" width="200" height="100"> <a href="update-image2.php?id=<?php echo $row['id'];?>">Change Image2</a>
</div>
</div>
...
<div class="control-group">
<label class="control-label" for="basicinput">3-е изображение продукта</label>
<div class="controls">
<img src="productimages/<?php echo htmlentities($pid);?>/<?php echo htmlentities($row['productImage3']);?>" width="200" height="100"> <a href="update-image3.php?id=<?php echo $row['id'];?>">Change Image3</a>
</div>
</div>
<?php } ?>
	<div class="control-group">
