...
<head>
	...
	<title>Admin| Управление продуктами</title>
...
?>									
										<tr>
											...
											<a href="manage-products.php?id=<?php echo $row['id']?>&del=delete" onClick="return confirm('Вы уверены, что хотите удалить запись?')"><i class="icon-remove-sign"></i></a></td>
										</tr>
										<?php $cnt=$cnt+1; } ?>
