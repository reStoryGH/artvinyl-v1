		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-product-name item">Продукт</th>
			
					<th class="cart-qty item">Кол-во</th>
					<th class="cart-sub-total item">Цена за 1 шт.</th>
						<th class="cart-sub-total item">Стоимость доставки</th>
					<th class="cart-total">Всего</th>
...
<tr>
	<td colspan="9"><div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary"><a href="payment-method.php">Порядок оплаты</a></button>
...
<?php } else {?>
<tr>
<td colspan="10" align="center"><h4>Отложенных заказов не обнаружено</h4></td>
</tr>
<?php } ?>
