...
header('location:index.php');
	...
	if(isset($_POST['update']))
	{
		...
		if($query)
		{
echo "<script>alert('Адрес для выставления счетов был обновлен');</script>";
		}
	}
...
<div class="form-group">
					    <label class="info-title" for="Billing Address">Расчетный адрес<span>*</span></label>
						...
						<div class="form-group">
					    <label class="info-title" for="Billing State ">Регион<span>*</span></label>
