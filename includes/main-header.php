...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Название продукта" name="product" required="required" />
			...
			<li>
				<div class="cart-item product-summary">
					<div class="row">
						<div class="col-xs-4">
							<div class="image">
								<a href="#"><img src="admin/productimages/<?php echo $row['id'];?>/<?php echo $row['productImage1'];?>" width="50" height="50" alt=""></a>
							</div>
						</div>
						<div class="col-xs-7">
...
<div class="dropdown dropdown-cart">
		...
		<ul class="dropdown-menu">
			...
			<div class="clearfix cart-total">
				...
				<a href="#" class="btn btn-upper btn-primary btn-block m-t-20">Продолжить покупки</a>	
			</div><!-- /.cart-total-->
