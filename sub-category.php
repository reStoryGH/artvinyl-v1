...
<html lang="ru">
	<head>
        ...
        <!-- Fonts --> 
		<link href='https://fonts.googleapis.com/css2?family=Rubik+Mono+One&display=swap' rel='stylesheet' type='text/css'>
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/subcategory.png" alt="" class="img-responsive" width="870" height="255">
			</div>
...
{?>							
	...
	<div class="product">		
	  ...
	  <?php } } else {?>
		...
		<div class="col-sm-6 col-md-4 wow fadeInUp"> <h3>Продукция не найдена</h3>
		</div>
