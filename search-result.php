...
echo "<script>alert('Продукт добавлен в избранноеПродукт добавлен в избранное');</script>";
...
<!-- ================================== TOP NAVIGATION : END ================================== -->	            <div class="sidebar-module-container">
	            	<h3 class="section-title">Посмотрите еще:</h3>
...
<!-- ============================================== COLOR: END ============================================== -->
	...
	<div id="category" class="category-carousel hidden-xs">
		<div class="item">	
			<div class="image">
				<img src="assets/images/banners/search-result.png" alt="" class="img-responsive">
			</div>
