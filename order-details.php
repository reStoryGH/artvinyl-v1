		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-sub-total item">Цена продукта</th>
					<th class="cart-total item">Всего</th>
					<th class="cart-total item">Способ оплаты</th>
					<th class="cart-description item">Дата оформления заказа</th>
...
?>
				<tr>
					...
					<td>
 <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo htmlentities($row['orderid']);?>');" title="Отслеживание заказов">
					Информация</td>
				</tr>
<?php $cnt=$cnt+1;} } else { ?>
