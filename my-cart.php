...
if(isset($_POST['submit'])){
		...
		foreach($_POST['quantity'] as $key => $val){
			...
			echo "<script>alert('Корзина обновлена');</script>";
		}
	}
...
if(!empty($_SESSION['cart'])){
	?>
		<table class="table table-bordered">
			<thead>
				<tr>
					<th class="cart-romove item">Удалить из списка</th>
				...
				<tr>
					<td colspan="7">
						<div class="shopping-cart-btn">
							<span class="">
								<a class="btn btn-upper btn-primary outer-left-xs" onclick="javascript:history.back(); return false;">Продолжить покупки</a>
...
<div class="col-md-4 col-sm-12 estimate-ship-tax">
	<table class="table table-bordered">
		<thead>
			<tr>
				<th>
					<span class="estimate-title">Дирекция по выставлению счетов</span>
				</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr>
				<th>
					...
					<div class="cart-grand-total">
						 Всего<span class="inner-left-md"><?php echo $_SESSION['tp']="$totalprice". ".00"; ?> ₽</span>
					</div>
				</th>
			</tr>
		</thead><!-- /thead -->
				...
				<tr>
					<td>
						<div class="cart-checkout-btn pull-right">
							<button type="submit" name="ordersubmit" class="btn btn-primary">ПРОИЗВЕСТИ ОПЛАТУ</button>
