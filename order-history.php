		...
		<table class="table table-bordered">
			<thead>
				<tr>
					...
					<th class="cart-description item">Время оформления заказа</th>
					<th class="cart-total last-item">Статус</th>
				</tr>
			</thead><!-- /thead -->
				...
				<tr>
					...
					<td class="cart-image">
						<a class="entry-thumbnail" href="detail.html">
						    <img src="admin/productimages/<?php echo $row['proid'];?>/<?php echo $row['pimg1'];?>" alt="" width="150" height="150">
						</a>
					</td>
