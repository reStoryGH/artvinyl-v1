...
{
alert("Поле подтверждения пароля пустое!");
...
<div class="form-group">
					    <label class="info-title" for="name">Никнейм (имя) пользователя<span>*</span></label>
...
<div class="form-group">
					    <label class="info-title" for="Current Password">Нынешний пароль<span>*</span></label>
			 ...
			 <input type="password" class="form-control unicase-form-control text-input" id="newpass" name="newpass">
					  ...
					  <div class="form-group">
					    <label class="info-title" for="Confirm Password">Подтверждение нового пароля <span>*</span></label>
					    <input type="password" class="form-control unicase-form-control text-input" id="cnfpass" name="cnfpass" required="required" >
					  </div>
					  <button type="submit" name="submit" class="btn-upper btn btn-primary checkout-page-button">Обновить </button>
					</form> 
